...
import {getCurrentMailDates, getCurrentMessageContext} from "../popup/mail-context.js";
...
browser.runtime.onMessage.addListener((message) => {
    ...
    if (action === 'getDetectionContext') {
        // Used by the highlight content script, which has its own (better)
        // view of the body -- the real rendered DOM -- and only needs the
        // parts it can't read itself: subject, reference date, date-order
        // preference, and any .ics attachments. Content scripts don't have
        // direct messenger.* access, hence the message round-trip.
